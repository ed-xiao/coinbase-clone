        ...
        return (
            <div className='welcome'>
                ...
                <div className='welcome-image-text'>
                    ...
                    <p>CoinLabo has a variety of features that make it the best place to start trading</p>
                </div>
                <div className='welcome-image'>
                    ...
                    <img src={window.COIN1} alt="Coinbase Desktop and Mobile App" loading="auto"/>
                </div>
            </div>
        );
    }
